...
<ParamField name="text" type="String" required>
  The dialogue text to compile into a resource
</ParamField>

<ResponseField name="returns" type="DialogueResource">
...
See the [Runtime Generation](/advanced/runtime-generation) guide for more details and use cases.
