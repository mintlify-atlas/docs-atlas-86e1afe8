...
<CardGroup cols={2}>
  ...
  <Card title="Using Dialogue" icon="code" href="/using-dialogue">
    Deep dive into the API and advanced integration techniques
  </Card>
  <Card title="Conditions & Mutations" icon="code-branch" href="/conditions-mutations">
    Add game state checks and variable modifications to your dialogue
  </Card>
  <Card title="Custom Balloons" icon="paint-brush" href="/dialogue-balloons">
